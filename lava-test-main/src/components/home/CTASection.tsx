...
export const CTASection = () => {
  return (
    <section className="py-20 pb-0 relative overflow-hidden bg-muted/20">
      <div className="container mx-auto px-4 text-center">
        ...
        <Button className="bg-gradient-lava hover:opacity-90 transition-opacity shadow-glow-lg text-lg px-8 py-6">
          Stake Now
        </Button>
      </div>
    </section>
